...
| Embedded credential extraction | Public-client flow contains no secret                                                                    | Public client ID is intentionally discoverable                                |
...
| Excess Azure DevOps access     | Delegated read-only scope and signed-in user's own permissions                                           | Tenant administrators control final consent grants                            |
